...
export default function TermsPage() {
  ...
  useEffect(() => {
    document.title = "ZiplyRide - Terms and Conditions";
    const metaDescription = document.createElement("meta");
    metaDescription.name = "description";
    metaDescription.content = "ZiplyRide Terms and Conditions: Understand your responsibilities and rights when using our bike and auto ride-hailing services.";
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 container py-16 md:py-24">     
         <h1 className="text-3xl md:text-4xl font-bold mb-8">Terms and Conditions for ZiplyRide</h1>
        <div className="prose dark:prose-invert max-w-none space-y-4">
          {lastUpdated && <p className="font-semibold">Last updated: {lastUpdated}</p>}
          <p>
            Welcome to ZiplyRide! These terms and conditions outline the rules and regulations for the use of ZiplyRide's Website and Mobile Application (collectively, "Services").
          </p>
          <p>
            By accessing or using our Services, we assume you accept these terms and conditions. Do not continue to use ZiplyRide if you do not agree to all of the terms and conditions stated on this page.
          </p>
          <h2 className="text-2xl font-semibold mt-6">License to Use Services</h2>
          <p>
            Unless otherwise stated, ZiplyRide and/or its licensors own the intellectual property rights for all material on ZiplyRide. All intellectual property rights are reserved. You may access our Services for your own personal, non-commercial use subjected to restrictions set in these terms and conditions.
          </p>
           <p>You must not:</p>
          <ul>
              <li>Republish material from ZiplyRide without prior written consent.</li>
              <li>Sell, rent or sub-license material from ZiplyRide.</li>
              <li>Reproduce, duplicate or copy material from ZiplyRide for commercial purposes.</li>
              <li>Redistribute content from ZiplyRide.</li>
          ...
          <h2 className="text-2xl font-semibold mt-6">Ride Booking and Services</h2>        
            <ul>
                <li>ZiplyRide provides a platform to connect users seeking transportation (Riders) with independent third-party transportation providers (Drivers).</li>
          ...
          <p>
            If you have any questions about these Terms and Conditions, please contact us at support@ziplyride.com
          </p>
        </div>
      </main>
      <Footer />
